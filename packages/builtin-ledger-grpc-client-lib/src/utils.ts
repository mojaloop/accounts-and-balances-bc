...
import {GrpcAccount, GrpcAccount__Output} from "packages/grpc-client-lib/src/types/GrpcAccount";
import {GrpcJournalEntry, GrpcJournalEntry__Output} from "packages/grpc-client-lib/src/types/GrpcJournalEntry";
