...
var grpc_server_1 = require("./grpc_server");
/* ********** Constants Begin ********** */
// General.
var BOUNDED_CONTEXT_NAME = "accounts-and-balances-bc";
var SERVICE_NAME = "grpc-svc";
...
// Server.
var GRPC_SERVER_HOST = process.env.ACCOUNTS_AND_BALANCES_HTTP_SERVER_HOST || "localhost";
var GRPC_SERVER_PORT_NO = parseInt(process.env.ACCOUNTS_AND_BALANCES_HTTP_SERVER_PORT_NO || "") || 1234;
/* ********** Constants End ********** */
var logger;
var auditingClient;
var accountsRepo;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 32:
                    ...
                    // HTTP server.
                    grpcServer = new grpc_server_1.GrpcServer(logger, tokenHelper, aggregate, GRPC_SERVER_HOST, GRPC_SERVER_PORT_NO);
                    _a.label = 33;
                case 33:
...
function stop() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!grpcServer) return [3 /*break*/, 2];
                    return [4 /*yield*/, grpcServer.stop()];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
