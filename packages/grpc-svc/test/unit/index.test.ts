...
import {BuiltinLedgerGrpcService} from "@mojaloop/accounts-and-balances-bc-builtin-ledger-grpc-svc/dist/application";
import {BuiltinLedgerGrpcClient} from "@mojaloop/accounts-and-balances-bc-builtin-ledger-grpc-client-lib";
...
import {AccountsAndBalancesGrpcService} from "../../src";
...
describe("accounts and balances gRPC service - unit tests", () => {
	beforeAll(async () => {
		...
		await AccountsAndBalancesGrpcService.start(logger, undefined, undefined, chartOfAccountRepo);
