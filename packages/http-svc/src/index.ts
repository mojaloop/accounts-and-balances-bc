...
import {Aggregate, IAccountsRepo, IJournalEntriesRepo} from "@mojaloop/accounts-and-balances-bc-domain-lib";
...
import {Privileges} from "@mojaloop/accounts-and-balances-bc-domain-lib/src/privileges";
