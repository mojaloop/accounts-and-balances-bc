...
const SERVICE_NAME: string = "mongo-accounts-repo-integration-tests";
...
describe("accounts and balances infrastructure library - MongoAccountsRepo integration tests", () => {
	beforeAll(async () => {
